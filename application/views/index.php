...
<a class="btn btn-success" href="<?php echo base_url('home/spreadhseet_format_download');?>">Download Excel Format</a>
<a class="btn btn-info" href="<?php echo base_url('home/spreadsheet_export');?>">Download Excel Data</a>
</span>
</h2>
<hr>
<?php

...
<body class="bg-gradient-primary">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" id="frm" action="<?= base_url() ?>welcome/home">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="email" name="email" id="email" placeholder="Email" 
                        ...
                        <?php echo form_error('password');?>
                                    ...
                                    <div class="text-center">
                                        <?php echo anchor('welcome/add','Create an Account!');?>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="<?php echo base_url('assest/admin_assest/vendor/jquery/jquery.min.js');?>"></script>
    <script src="<?php echo base_url('assest/admin_assest/vendor/bootstrap/js/bootstrap.bundle.min.js');?>"></script>
